...
本文面向 `src/` 工作空间的开发、集成和现场调试人员，说明各功能包职责、信息输入输出方式、运动控制链路、接口使用方法以及静态代码审查发现的风险。

文档结构参考 RealManRobot ROS 2 中文资料常用的“功能包用途、目录结构、接口说明、使用示例、注意事项”形式，接口名称和结论全部以本工程源码为准。
